...
<p align="center">
  ...
  <a href="https://www.testmuai.com/hyperexecute"><img src="https://img.shields.io/badge/HyperExecute-Cucumber-brightgreen.svg?style=for-the-badge&labelColor=000000" alt="HyperExecute Cucumber"></a>
...
With TestMu AI (Formerly LambdaTest), you can run Selenium Cucumber tests across real browsers and operating systems at scale. This sample shows how to configure HyperExecute Cucumber tests to run on the TestMu AI cloud, including GitHub Actions integration with Auto-Split and Matrix execution modes.
...
```bash
git clone https://github.com/LambdaTest/HyperExecute-Cucumber-Gh-actions-Demo.git
cd HyperExecute-Cucumber-Gh-actions-Demo
```
...
The repo includes YAML configurations for both Auto-Split and Matrix execution modes under `yaml/win/` and `yaml/linux/`.

**Auto-Split YAML key settings:**
```yaml
globalTimeout: 150
